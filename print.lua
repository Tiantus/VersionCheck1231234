...
local name="Crystal Cheats - $6.00 USD"
...
MiscTabMainSection:Textbox("Custom Chat Message","Crystal Cheats On Top",function(x)
...
MiscTabMenuSection:Textbox("Menu Title","CRYSTAL CHEATS",function(x)
    local a=x 
    local b={}
    for i=1,#a do
...
local name="Crystal Cheats - "..identifyexecutor()..""
...
spawn(function()
while wait(1) do 
    game.CoreGui["Crystal Cheats - $6.00 USD"].Drag.Main.Heading.Label:Destroy()
game.CoreGui["Crystal Cheats - $6.00 USD"].Drag.Main.Heading.Differ:Destroy()
game.CoreGui["Crystal Cheats - $6.00 USD"].Drag.Main.Heading.Differ:Destroy()
